...
public class UltraFastController : ControllerBase
{
    private readonly IUltraFastBitArrayFilter _filter;
    private readonly IPerformanceMonitor _monitor;

    public UltraFastController(IUltraFastBitArrayFilter filter, IPerformanceMonitor monitor)
    {
        _filter = filter;
        _monitor = monitor;
    }
    ...
    {
        var result = await _monitor.TrackOperationAsync("UltraFast_Validate", 
